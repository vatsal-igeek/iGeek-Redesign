    ...
    const rootClasses = useMemo(
      () =>
        cx(
          ...
          "[--logoloop-fadeColor:var(--color-background-primary)]",
              ...
              <>
                <div
                  ...
                  className={cx(
                    ...
                    "h-[clamp(72px,22%,660px)]",
                    "bg-[linear-gradient(to_bottom,var(--logoloop-fadeColor)_0%,rgba(0,0,0,0)_100%)]"
                  )}
                />
                <div
                  aria-hidden
                  className={cx(
                    ...
                    "h-[clamp(72px,22%,660px)]",
                    "bg-[linear-gradient(to_top,var(--logoloop-fadeColor)_0%,rgba(0,0,0,0)_100%)]"
                  )}
                />
              </>
            ) : (
